...
${H("hideComments")} ytm-comment-input-box-carousel-item-view-model, ${H("hideComments")} yt-comment-input-box-carousel-item-view-model,
${H("hideComments")} ytm-watch ytm-item-section-renderer:has(yt-video-metadata-carousel-view-model), ${H("hideComments")} ytm-watch yt-video-metadata-carousel-view-model,
${H("hideComments")} ytm-engagement-panel[target-id*="comments"], ${H("hideComments")} ytm-engagement-panel-section-list-renderer[target-id*="comments"] { display: none !important; }
